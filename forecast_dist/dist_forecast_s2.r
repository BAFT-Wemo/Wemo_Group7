...
train_s2_d1_d3 <- train_s2%>%
  filter(admin_town_zh != "板橋區" & admin_town_zh != "松山區"
...
naive_df_s2 <- data.frame(forecast = rep(naive_pred_s2, 28),
                          admin_town_en = rep(naive_towns_s2, 28))
...
forecast_results <- rbind(train_s2_x, naive_forecast_date)
